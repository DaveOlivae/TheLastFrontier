    ...
    private void setInstance(int instance) {
        ...
        switch (instance) {
            ...
            case 5:
                ...
                addEnemy(new EN_RaiderGreen(getGp()), 14 * tileSize, 25 * tileSize);
                addItem(new Apple(), 16 * tileSize, 12 * tileSize);
                addEvent(new Crows(0.0001));
                break;
            case 6:
                setEnvPath("/maps/forest6.csv");
                addEnemy(new EN_RaiderPurple(getGp()), 14 * tileSize, 25 * tileSize);
                addItem(new Apple(), 16 * tileSize, 12 * tileSize);
                addEvent(new Crows(0.0001));
                break;
            case 7:
            ...
            case 8:
                ...
                addEnemy(new EN_RaiderBrown(getGp()), 14 * tileSize, 25 * tileSize);
                addItem(new Apple(), 16 * tileSize, 12 * tileSize);
                addEvent(new Crows(0.0001));
                break;
            case 9:
                setEnvPath("/maps/forest9.csv");
                addEnemy(new EN_RaiderBlue(getGp()), 14 * tileSize, 25 * tileSize);
                addItem(new Apple(), 16 * tileSize, 12 * tileSize);
                addEvent(new Crows(0.0001));
                break;
            case 10:
